...
return [
    ...
    */
    'attributes' => [
		...
		"file" => "فایل",
		"fullname" => "نام کامل",
        "default_problem_massage"=>"پیام پیشفرض مشکل آگهی",
        "problem_message_type"=>"مدل پیام مشکل آگهی",
        "problem_message"=>"پیام مشکل آگهی",
        "value"=>"مقدار مورد نظر",
        "property_area"=>"مساحت",
        "room_count"=>"تعداد اتاق",
        "construction_year"=>"سال ساخت",
        "floor"=>"طبقه",
        "parking_status"=>"وضعیت پارکینگ",
        "elevator_status"=>"وضعیت آسانسور",
        "storage_status"=>"وضعیت انباری",
        "activation_status"=>"وضعیت فعال بودن آگهی",
        "longitude"=>"طول جغرافیایی",
        "latitude"=>"عرض جغرافیایی",
        "video_url"=>"فیلم شاخص آگهی",
        "top_deed_img_url"=>"تصویر سند",
        "bottom_deed_img_url"=>"تصویر سند",
        "time_limitation"=>"محدودیت زمان",
        "room_number"=>"شماره اتاق",
        "img_url"=>"تصویر",
        "field"=>"فیلد",
        "phone_number"=>"شماره موبایل",
        "activate"=>"وضعیت فعال بودن",
    ],
];
